...
<head>
    ...
    <style>
        * {
        ...
        .button3 {background-color: #D0312D;} /* Red */
    </style>
</head>
<body>
<header>
...
<section>
    <nav>
        <ul>
            <li><a href="/register.do"><fmt:message key="REGISTER" bundle="${board}" /></a></li>
    ...
    <article>
        ...
        <h3><fmt:message key="WAccess" bundle="${board}" /></h3>
        <h3><a href="/"><fmt:message key="GtM" bundle="${board}" /></a></h3>
    </article>
